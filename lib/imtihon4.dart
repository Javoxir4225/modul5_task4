        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              width: 350,
              decoration: BoxDecoration(
                color: Color.fromARGB(255, 129, 73, 241),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: 8),
                Text(
                  "Dr. Stevi Jessi is the top most General Dentist in Nanyanyang Hospotalat London. She is available for private consultation",
                  style: TextStyle(
                    color: Colors.grey,
                    fontSize: 14,
                  ),
          ...
          Row(
            children: [
              _kalendar("7", "Sun", false),
              _kalendar("8", "Mon", true),
              _kalendar("9", "Tue", true),
          ...
          ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color.fromARGB(255, 129, 73, 241),
    ...
    return set
        ...
        : TextButton(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(16),
                color: const Color.fromARGB(255, 129, 73, 241),
              ),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
